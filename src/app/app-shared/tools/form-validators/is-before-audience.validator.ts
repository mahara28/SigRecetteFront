...
const error = {'affaire.table.audience.dateAfterConvocation': 'affaire.table.audience.dateAfterConvocation'};

export function BeforeDateConvocation(date: AbstractControl): ValidatorFn {
      return (control) => {
